...
export const permissionRoles = {
  ...
  "patients:view": ["super_admin", "admin", "doctor", "nurse", "receptionist", "lab_technician"],
  ...
  "appointments:view": ["super_admin", "admin", "doctor", "nurse", "receptionist"],
  "appointments:create": ["super_admin", "admin", "doctor", "receptionist"],
  "appointments:update": ["super_admin", "admin", "doctor", "receptionist"],
  "appointments:delete": ["super_admin", "admin"],
  "medical-records:view": ["super_admin", "admin", "doctor", "nurse"],
  ...
  "prescriptions:view": ["super_admin", "admin", "doctor", "nurse", "pharmacist"],
  ...
  "laboratory:view": ["super_admin", "admin", "doctor", "nurse", "lab_technician", "pharmacist"],
  ...
  "billing:view": ["super_admin", "admin", "doctor", "receptionist"],
